...
<img src="assets/markdowneditor.clip.gif" alt="Markdown Editor Walkthrough" width="100%">

<div align="center">
  <p><em>A standardized, split-pane markdown editing experience with live rendering, custom Obsidian syntax parsing, and robust file saving.</em></p>
</div>
...
| **[src/index.jsx](src/index.jsx)** | Main bootstrapper and loader hook that handles namespaces and builds the view. |
| **[src/App.jsx](src/App.jsx)** | Main coordinator component containing editor states, rendering, and logic. |
